...
import com.qualcomm.QCARSamples.ImageTargets.R.layout;
...
public class ShellManager extends FrameLayout {
    ...
    public static final String DEFAULT_SHELL_URL = "http://mrdoob.github.io/three.js/examples/#webgl_custom_attributes_particles2";
    ...
    public ShellManager(Context context, AttributeSet attrs) {
        ...
        mContentViewRenderView = new ContentViewRenderView(context) {
            ...
            protected void onReadyToRender() {
                    mActiveShell.loadUrl(DEFAULT_SHELL_URL);
            }
        };
    }
